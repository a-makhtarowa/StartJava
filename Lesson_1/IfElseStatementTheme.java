public class IfElseStatementTheme {   
    public static void main(String[] args) {
        ...
        double percentSum = depositSum * 0.01 * depositPercent;
        System.out.println("Начисленная сумма по вкладу - " + percentSum);
        System.out.println("Итоговая сумма с процентом - " + (depositSum + percentSum));
        ...
        int count100 = withdrawFromAtm / 100;
        withdrawFromAtm -= count100 * 100;
        int count10 = withdrawFromAtm / 10;
        if (count10 > banknotesLeft10) {
            count10 = banknotesLeft10;
        }
        withdrawFromAtm -= count10 * 10;
        System.out.println("Банкноты номиналом:\n1 - " + withdrawFromAtm + "\n10 - " + count10 + 
                "\n100 - " + count100);
        System.out.println("Общая сумма: " + (withdrawFromAtm + count10 * 10 + count100 * 100));
    }
}